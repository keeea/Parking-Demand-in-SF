...
ggplot() + 
  geom_sf(data = neighborhood_sf,fill="#FDF9FA",size=0.2) +
...
```{r Joining neighborhood data to the fishnett, fig.width=12}
...
```{r spatial correlation map by dotw,fig.width=6}
