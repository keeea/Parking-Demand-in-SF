...
grid.arrange(ncol = 3,
  ...
  ggplot() +
    ...
    scale_fill_manual(values = palette5_3,
                      ...
                      name = "Percentage")+
    labs(title = "Percentage of People Who Take \n Public Transportation to Work")+
    mapTheme())
```
...
```{r Ploting the MAE,fig.width=6,fig.height=4}
...
```{r plot the MAE of mean count, fig.width=9,fig.height=4}
...
```{r Errors in time series,fig.height=12}
...
```{r Mean Absolute Errors by grid and by week, fig.width=4}
predictions_AverageMeter %>% 
