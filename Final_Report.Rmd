...
```{r time lag correlation,fig.width=6}
...
```{r spatial correlation map by week,fig.width=6}
...
```{r Creating models, echo=TRUE, message=FALSE, warning=FALSE, paged.print=TRUE}
OLS_reg1 <- 
...
```{r Errors in time series, fig.width=6}
...
```{r Mean Absolute Errors by grid and by week}
predictions_AverageMeter %>% 
