...
## 3.2 Creating fishnet and joining with data
...
### 3.3.4 Combining all variables into one fishnet
...
## 3.4 Creating the space/time panel- Selecting temporal units
...
## 3.5 Split train and test data sets
